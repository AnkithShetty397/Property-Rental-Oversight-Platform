...
export declare const valibot: <T extends SupportedSchemas>(schema: T, options?: {
    definitions?: Record<string, import("valibot").AnySchema | import("valibot").LiteralSchema<any> | import("valibot").NullSchema | import("valibot").NumberSchema | import("valibot").BigintSchema | import("valibot").StringSchema | import("valibot").BooleanSchema | import("valibot").NullableSchema<any> | import("valibot").ObjectSchema<any, any> | import("valibot").RecordSchema<any, any> | import("valibot").ArraySchema<any> | import("valibot").TupleSchema<any, any> | import("valibot").IntersectSchema<any> | import("valibot").UnionSchema<any> | import("valibot").VariantSchema<any, any> | import("valibot").PicklistSchema<any> | import("valibot").EnumSchema<any> | import("valibot").LazySchema<any> | import("valibot").DateSchema | import("valibot").NullishSchema<any> | import("valibot").OptionalSchema<any> | import("valibot").UndefinedSchema> | undefined;
    strictObjectTypes?: boolean | undefined;
    dateStrategy?: ("string" | "integer") | undefined;
    undefinedStrategy?: "any" | undefined;
    bigintStrategy?: ("string" | "integer") | undefined;
