 ...
 * Lazy schema type.
 */
type LazySchema<TGetter extends (input: unknown) => BaseSchema, TOutput = Output<ReturnType<TGetter>>> = BaseSchema<Input<ReturnType<TGetter>>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'lazy';
 ...
 */
declare const recursive: typeof lazy;

/**
 * Lazy schema async type.
 */
type LazySchemaAsync<TGetter extends (input: unknown) => MaybePromise<BaseSchema | BaseSchemaAsync>, TOutput = Output<Awaited<ReturnType<TGetter>>>> = BaseSchemaAsync<Input<Awaited<ReturnType<TGetter>>>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'lazy';
 ...
 */
declare const recursiveAsync: typeof lazyAsync;
 ...
 */
type NonNullableSchema<TWrapped extends BaseSchema, TOutput = NonNullableOutput<TWrapped>> = BaseSchema<NonNullableInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_nullable';
 ...
 */
type NonNullableSchemaAsync<TWrapped extends BaseSchema | BaseSchemaAsync, TOutput = NonNullableOutput<TWrapped>> = BaseSchemaAsync<NonNullableInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_nullable';
 ...
 */
type NonNullishSchema<TWrapped extends BaseSchema, TOutput = NonNullishOutput<TWrapped>> = BaseSchema<NonNullishInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_nullish';
 ...
 */
type NonNullishSchemaAsync<TWrapped extends BaseSchema | BaseSchemaAsync, TOutput = NonNullishOutput<TWrapped>> = BaseSchemaAsync<NonNullishInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_nullish';
 ...
 */
type NonOptionalSchema<TWrapped extends BaseSchema, TOutput = NonOptionalOutput<TWrapped>> = BaseSchema<NonOptionalInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_optional';
 ...
 */
type NonOptionalSchemaAsync<TWrapped extends BaseSchema | BaseSchemaAsync, TOutput = NonOptionalOutput<TWrapped>> = BaseSchemaAsync<NonOptionalInput<TWrapped>, TOutput> & {
    /**
     * The schema type.
     */
    type: 'non_optional';
 ...
 */
declare function strict<TSchema extends ObjectSchema<ObjectEntries, undefined>>(schema: TSchema): TSchema;
 ...
 * @returns A strict object schema.
 */
declare function strictAsync<TSchema extends ObjectSchemaAsync<ObjectEntriesAsync, undefined>>(schema: TSchema): TSchema;
 ...
 */
type EveryValidation<TInput extends any[]> = BaseValidation<TInput> & {
    /**
     * The validation type.
     */
    type: 'every';
 ...
 */
type HashValidation<TInput extends string> = BaseValidation<TInput> & {
    /**
     * The validation type.
     */
    type: 'hash';
 ...
 */
type SomeValidation<TInput extends any[]> = BaseValidation<TInput> & {
    /**
     * The validation type.
     */
    type: 'some';
