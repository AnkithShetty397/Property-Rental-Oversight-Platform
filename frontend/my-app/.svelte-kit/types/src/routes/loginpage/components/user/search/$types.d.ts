...
type RouteParams = {  };
type RouteId = '/loginpage/components/user/search';
...
type LayoutRouteId = RouteId | "/loginpage/components/user/search/search1" | "/loginpage/components/user/search/search2"
