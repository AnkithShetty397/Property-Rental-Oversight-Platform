...
type RouteParams = {  };
type RouteId = '/loginpage/components/user/editprofile';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/loginpage/components/user/editprofile/+page.server.js').load>>>>>>;
