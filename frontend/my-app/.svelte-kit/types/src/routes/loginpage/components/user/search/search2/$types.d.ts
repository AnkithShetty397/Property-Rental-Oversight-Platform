...
type RouteParams = {  };
type RouteId = '/loginpage/components/user/search/search2';
...
type PageParentData = Omit<Omit<Omit<Omit<Omit<EnsureDefined<import('../../../../../$types.js').LayoutData>, keyof import('../../../../$types.js').LayoutData> & EnsureDefined<import('../../../../$types.js').LayoutData>, keyof import('../../../$types.js').LayoutData> & EnsureDefined<import('../../../$types.js').LayoutData>, keyof import('../../$types.js').LayoutData> & EnsureDefined<import('../../$types.js').LayoutData>, keyof import('../$types.js').LayoutData> & EnsureDefined<import('../$types.js').LayoutData>, keyof LayoutData> & EnsureDefined<LayoutData>;
type LayoutRouteId = RouteId | "/loginpage/components/user/search/search2"
type LayoutParams = RouteParams & {  }
type LayoutParentData = Omit<Omit<Omit<Omit<EnsureDefined<import('../../../../../$types.js').LayoutData>, keyof import('../../../../$types.js').LayoutData> & EnsureDefined<import('../../../../$types.js').LayoutData>, keyof import('../../../$types.js').LayoutData> & EnsureDefined<import('../../../$types.js').LayoutData>, keyof import('../../$types.js').LayoutData> & EnsureDefined<import('../../$types.js').LayoutData>, keyof import('../$types.js').LayoutData> & EnsureDefined<import('../$types.js').LayoutData>;
