...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let param = "";
  $$result.css.add(css);
  return `<body><div class="search-container svelte-155jl80"><input type="text"${add_attribute("placeholder", "Search...", 0)} class="svelte-155jl80"${add_attribute("value", param, 0)}> <button type="submit" class="svelte-155jl80" data-svelte-h="svelte-141loiu"><i class="fa fa-search"></i>Search</button></div> <div>${slots.default ? slots.default({}) : ``}</div> </body>`;
});
export {
  Layout as default
};
