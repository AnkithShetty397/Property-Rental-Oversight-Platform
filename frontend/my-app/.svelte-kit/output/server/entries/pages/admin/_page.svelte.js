...
import Page$1 from "./alteremployees/_page.svelte.js";
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="main-container svelte-1u6lwwh"><div class="buttons svelte-1u6lwwh"><div><button class="${["top-buttons svelte-1u6lwwh", ""].join(" ").trim()}" data-svelte-h="svelte-1awntg0">Add/Remove Employees</button> <button class="${["top-buttons svelte-1u6lwwh", ""].join(" ").trim()}" data-svelte-h="svelte-1gpxm3v">Create Owners</button></div></div> <div class="body-container svelte-1u6lwwh">${`${`${validate_component(Page$1, "InboxPage").$$render($$result, {}, {}, {})}`}`}</div> </div>`;
});
export {
  Page as default
};
